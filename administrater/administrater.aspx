<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="administrater.aspx.cs" Inherits="CollegeWebsite.administrater.administrater" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div style="height: 460px; width: 798px;" align="right">&nbsp;<div align="center" 
        ...
        <asp:Image ID="Image2" runat="server" Width="505px" Height="257px" 
                ImageUrl="~/images/admin_login.png" /></div>
